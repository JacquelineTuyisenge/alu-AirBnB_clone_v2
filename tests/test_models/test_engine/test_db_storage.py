...
class TestDBStorage(unittest.TestCase):
    ...
    def test_user(self):
        """ Tests user """
        user = User(name="Jacqueline", email="tuyisengejacqui@gmail.com", password="12345j")
        user.save()
        self.assertTrue(user.id in self.storage.all())
        self.assertEqual(user.name, "Jacqueline")
    ...
    def test_place(self):
        ...
        user = User(name="Jacqueline", email="jacquel@gmail.com", password="12345j")
        user.save()
    ...
    def test_review(self):
        ...
        user = User(name="Jacqueline", email="jacky2gmail.com", password="12345j")
        user.save()
